...
var objContent = {
	'home':  { contentText : textHome, contentImage : "images/3.bmp" },
	'womenrowing':    { contentText : textWomenRowing, contentImage : "images/3.bmp" },
	'menrowing': { contentText : textMenRowing, contentImage : "images/3.bmp" },
	'learntorow': { contentText : textLearnToRow, contentImage : "images/3.bmp" },
	'recreational': { contentText : textRecreational, contentImage : "images/3.bmp" }
};
...
function openPage(evt, aPage, displayLeftMenu){
    ...
    document.getElementsByClassName("flex-container-menu")[0].style.visibility = "hidden";
    //document.getElementsByClassName("flex-container-menu")[0].style.display = "none";

    if(evt.currentTarget.classList.contains("tablinks")){
        document.getElementsByClassName("flex-container-menu")[0].style.visibility = "visible";
        //document.getElementsByClassName("flex-container-menu")[0].style.display = "block";
    ...
    if (evt.currentTarget.className == "menuoption") {
        menuoptions = document.querySelectorAll('.flex-container-topnav >ul>li>a');
